...
export default function BookingDates({booking,className}) {
    ...
    BookingDates.propTypes = {
        booking: PropTypes.shape({
          checkIn: PropTypes.string.isRequired, // You can adjust the type based on the actual data type
          checkOut: PropTypes.string.isRequired, // You can adjust the type based on the actual data type
        }).isRequired,
